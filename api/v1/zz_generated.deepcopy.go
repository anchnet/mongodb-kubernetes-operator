...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MongoDBCommunityNode) DeepCopyInto(out *MongoDBCommunityNode) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MongoDBCommunityNode.
func (in *MongoDBCommunityNode) DeepCopy() *MongoDBCommunityNode {
	if in == nil {
		return nil
	}
	out := new(MongoDBCommunityNode)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MongoDBCommunityStatus) DeepCopyInto(out *MongoDBCommunityStatus) {
	*out = *in
	if in.Nodes != nil {
		...
		*out = make([]MongoDBCommunityNode, len(*in))
		copy(*out, *in)
	}
}
